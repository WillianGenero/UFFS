...
?>
		<section class="container">
			<div class="lista-opcoes">
				...
				<?php
					$sql = "select pr.codigo, pr.nomePopular, pr.preco, pr.imagem from produto pr join decorativo d on d.codProduto=pr.codigo";
					...
					if(mysqli_num_rows($rest) == 0)
						...
						while($produto = mysqli_fetch_array($rest)){
							...
							<div class="produto">
								<figure>
									<img src="../img/decorativos/<?=$produto['imagem'];?>" alt="Decorativo: <?=$produto['nomePopular'];?>">
